...
#Hyperparameter search with 5-fold CV on windows_train_dataset
search_space = [
...
def run_cv_for_config(cfg, windows_train_dataset, seed):
    ...
    y_train_all = np.array([y for y in SliceDataset(windows_train_dataset, idx=1)])  # labels
...
final_model = EEGNet(n_chans=n_chans, n_outputs=n_classes,
